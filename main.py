...
class SpaceObject:
    ...
    def __init__(self, sprite, x, y, x_speed, y_speed):
...
class Game:
    ...
    def load_resources(self):
        ...
        self.asteroid_image_b = pyglet.image.load("./Assetss/PNG/Meteors/meteorGrey_big1.png")
    ...
    def init_objects(self):
        ...
        self.create_asteroids(random.randint(2, 10))

    def create_asteroids(self,count):
        "Vytvorenie X asteroidov"

        for i in range (count):
            asteroid = SpaceObject(self.asteroid_image_b, random.randint(0, WIDTH), random.randint(0, HEIGHT), random.randint(0, 50), random.randint(0, 50))
